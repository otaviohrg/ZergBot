...
#include "BT_STARCRAFT/BT_DECO_CONDITION_WAIT_ENOUGH_ZERGLINGS.h"
...
#include "BT_STARCRAFT/BT_ACTION_UPGRADE_LAIR.h"
#include "BT_STARCRAFT/BT_ACTION_RESEARCH_METABOLIC_BOOST.h"